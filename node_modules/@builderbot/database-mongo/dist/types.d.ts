...
import { MongoAdapter as Database } from '@builderbot/database-mongo'; // Importando o adaptador MongoDB personalizado
...
const confirmFlow = addKeyword(['confirmar'])
    .addAnswer(
        ...
        async (ctx, { flowDynamic, state }) => {
            ...
            try {
                const { transactionId, pix } = await createPixPayment(amount, 'email@example.com', '12345678900');
